    ...
    return (
        <Container style={{paddingTop:'40px'}}>
            ...
            <Row style={{paddingBottom:'50px',paddingTop:'20px'}}>
                ...
                <i className="fa fa-envelope fa-2x" style={{color:'rgb(51, 163, 47)'}}/><span style={{paddingLeft:'10px'}} className="call"> organiccarechennai@gmail.com</span>
                </Col>
                </Col>
                <Col md={6} style={{paddingRight:'0px'}}>
                <i className="fa fa-map-marker fa-2x" style={{color:'rgb(51, 163, 47)'}} />   
                <span style={{paddingLeft:'10px'}} className="call">
